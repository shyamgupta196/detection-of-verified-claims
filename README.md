...
- **sample.tsv** 
  The output file generated by running SimBa. Contains the five most similar claims in the dataset per input query in the [CLEF CheckThat! Lab Task 2 Claim Retrieval challenge](https://checkthat.gitlab.io/clef2022/) format.

- **pred_client.tsv**  
  A client-friendly output file, providing detailed results in a more human-readable format.
